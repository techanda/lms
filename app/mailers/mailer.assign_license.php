...
if(isset($download_path) && $download_path != '' && $download_path != '#'){
	$download_link = "		
		<a href='".$download_path."' >
			Click Here to Download the Application
		</a>";
} else {
	$download_link = "<em style='color:#666'>Sorry, a download link has not been configured for this application yet.</em> ";
}
...
<tr>
	<td style='padding:30px 0;margin-bottom:15px;font-family: Consolas, Helvetica, Arial, sans-serif;'>
		<h1>Your Software Request has been Approved.</h1>
		<p>Hello ".$first_name.",</p>
		<p>
			Your request for <strong>".$application."</strong> has been approved by ".$admin_team.". You 
			can now download the application and use the following license key to gain access to
			the application:
		</p>
	</td>
</tr>
<tr>
	<td style='padding:30px 0;border:2px solid black;background:#444;color:white;padding:15px;font-family: Consolas, Helvetica, Arial, sans-serif;'>
...
<tr>
	<td style='padding:30px 0;font-family: Consolas, Helvetica, Arial, sans-serif;'>
		<br>
		<br>
		".
		$download_link
