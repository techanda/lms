...
<div id="removeHwImageConfirm" class="modal fade vert-align" role="dialog">
  <div class='modal-dialog modal-sm'>
      ...
      <div class='modal-container'>
				...
				<p>Are you sure you want to remove the image of <strong><?= $hw_info['hw_name'] ?></strong>? </p>

				<form name='confirm_action' method='post' action='action.php?method=remove_hw_image'>
